...
Now, wrap the root of your app in the `UniversalUIConfigProvider` to provide global theming. More on how to [customize Universal UI here](/docs/getting-started/customization).
